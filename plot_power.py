...
def power_density_map(p, ch_number, nz, chosen_channels, out_path):
    ...
    for ch in range(ch_number):
        ...
        im = ax.imshow(p[ch], extent=[0, 0.5, 20, 60],
...
def get_power_plots(data_path, idx_names_path):
...
if __name__ == "__main__":
    get_power_plots("output/data_matrix.npy", "output/names_idx.json")
